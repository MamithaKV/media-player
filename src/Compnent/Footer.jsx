...
const Footer = () => {
  return (
      ...
      Media Player</h5>
      <p>Designed and built with all the love inthe world by the Luminar team with the help of our contributors</p>
      ...
      <a href="https://www.facebook.com/login/"style={{textDecoration:'none',color:'white'}} target='='_blank ><i className="fa-brands fa-facebook"></i></a>
      <a href="https://www.linkedin.com/company/login"style={{textDecoration:'none',color:'white'}} target='='_blank ><i className="fa-brands fa-linkedin"></i></a>
      <a href="https://github.com/github-login"style={{textDecoration:'none',color:'white'}} target='='_blank ><i className="fa-brands fa-github"></i></a>
      <a href="https://my.phone.com/"style={{textDecoration:'none',color:'white'}} target='='_blank ><i className="fa-solid fa-phone"></i></a>
      </div>
      </div>
      </div>
